...
const dbDirStage = "/vagrant/live/stage/data-stores/mysql"
const appDirStage = "/vagrant/live/stage/services/hello-world-app"
...
func createDbOpts(t *testing.T, terraformDir string) *terraform.Options {
	...
	bucketForTesting := "terraform-up-and-running-state-patrick"
